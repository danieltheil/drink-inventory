        ...
        <div className="card-container grid grid-cols-9 grid-rows-10 col-span-11 grid-flow-row">
          { isMobile || width < MAX_WIDTH ? (
              viewState === viewStates.alcoholView ? 
                (<MobileAlcCardView isMobile={ isMobile || width < MAX_WIDTH } setViewState={setViewState}/>) :
                (<MobileMixCardView isMobile={ isMobile || width < MAX_WIDTH } setViewState={setViewState}/>)
            ) : (
              viewState === viewStates.alcoholView ? 
